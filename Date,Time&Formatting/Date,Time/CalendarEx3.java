...
public class CalendarEx3 {
	...
	public static void main(String[] args) {
		...
		time1.set(Calendar.MINUTE, 20); //time1을 10시 20분 30초로 설정
		time1.set(Calendar.SECOND, 30); //time1을 10시 20분 30초로 설정
		
		
		time2.set(Calendar.HOUR_OF_DAY, 20); //tiem2를 20시 30분 10초로 설정
		time2.set(Calendar.MINUTE, 30); //tiem2를 20시 30분 10초로 설정
		time2.set(Calendar.SECOND, 10); //tiem2를 20시 30분 10초로 설정
